            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php $this->load->view('admin/categoria/listar_view'); ?>
...
<?php $this->load->view('admin/categoria/nuevo_view'); ?>

<script src="<?php echo URL_JS ?>pages/forms/admin/Categoria.js"></script>