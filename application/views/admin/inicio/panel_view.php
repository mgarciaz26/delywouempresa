                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-footer bg-c-blue">
                                <div class="row align-items-center">
                                    <div class="col-9">
                                        <p class="text-white m-b-0">Productos</p>
                                    </div>
                                    <div class="col-3 text-right">
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="<?php echo URL_IMAGES ?>user/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="<?php echo URL_IMAGES ?>user/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
