...
<!-- [ Main Content ] end -->
                ...
                <ul class="iew-download">
                    <li>
                        <a href="http://www.google.com/chrome/">
                            <img src="<?php echo URL_IMAGES ?>browser/chrome.png" alt="Chrome">
                            <div>Chrome</div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.mozilla.org/en-US/firefox/new/">
                            <img src="<?php echo URL_IMAGES ?>browser/firefox.png" alt="Firefox">
                            <div>Firefox</div>
                        </a>
                    </li>
                    <li>
                        <a href="http://www.opera.com">
                            <img src="<?php echo URL_IMAGES ?>browser/opera.png" alt="Opera">
                            <div>Opera</div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.apple.com/safari/">
                            <img src="<?php echo URL_IMAGES ?>browser/safari.png" alt="Safari">
                            <div>Safari</div>
                        </a>
                    </li>
                    <li>
                        <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                            <img src="<?php echo URL_IMAGES ?>browser/ie.png" alt="">
                            <div>IE (11 & above)</div>
                        </a>
                    </li>
                </ul>
    ...
    <!-- <script src="<?php echo URL_JS ?>menu-setting.min.js"></script> -->
	<script src="<?php echo URL_JS ?>plugins/sweetalert.min.js"></script>
    <script src="<?php echo URL_JS ?>pages/forms/admin/Dashboard.js"></script>
